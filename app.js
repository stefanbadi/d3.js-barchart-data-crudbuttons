...
//key function, to be passed alongside data in data()
var key = function(d) {
  return d.key;
};
...
d3.select('.remove').on('click', function() {
  ...
  // Remove bar, d3 initially doesnt know which element to remove
  bars
    .exit()
    .transition()
    .attr('x', -x_scale.bandwidth()) //this lets bar exit to the left instead of the right, chart_width to the right
    .remove();
